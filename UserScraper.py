...
class UserScraper(object):
    ...
    def __init__(self, url, website):
        ...
        # todo:rais error if don't define
        self._name = None
        ...
        self._new_location_name_in_website = None  # add this value as a flag for adding record to
        # Stack_Exchange_Location table
    ...
    def scrap_info(self):  # todo : drop and call from user
        """
